...
INT32 BBS_MakeSmugglerAd(starport_t *starport, bbsAdvert_t *slot);
INT32 BBS_MakeFakeSmugglerAd(starport_t *starport, bbsAdvert_t *slot);
INT32 BBS_MakeMilitaryAd(starport_t *starport, bbsAdvert_t *slot);
INT32 BBS_MakeMissingPersonAd(starport_t *starport, bbsAdvert_t *slot);
...
INT32 BBS_MakeCrewAd(starport_t *starport, bbsAdvert_t *slot);
INT32 BBS_MakeDonationAd(starport_t *starport, bbsAdvert_t *slot);
...
INT32 BBSCreateRandom(starport_t *starport, bbsAdvert_t *slot)
{
	...
	return /*BBS_MakeAssassinationAd(starport, slot);// Nick*/ BBSConstructors[idx](starport, slot);
}


void DeflagAdvert(bbsAdvert_t *ad, starport_t *starport)
{
...
INT32 MIL_MakePackage(INT32 rank);
INT32 MIL_MakeAssassination(INT32 rank);
INT32 MIL_MakePhotography(INT32 rank);
INT32 MIL_MakeBombing(INT32 rank);
