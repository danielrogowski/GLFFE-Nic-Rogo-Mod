...
/*
		// Nick
		s1 = (float)posReplacePylon[pylon].left	/ 640.0f;
		s2 = (float)posReplacePylon[pylon].right	/ 640.0f;
		t1 = (float)(posReplacePylon[pylon].top+mod)		/ 84.0f;
		t2 = (float)(posReplacePylon[pylon].bottom+mod)	/ 84.0f;*/
	}
